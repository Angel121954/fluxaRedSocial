...
return [
    ...
    */
    ...
    'password' => [
        ...
        'uncompromised' => 'El :attribute ingresado ha aparecido en una filtración de datos. Por favor elige uno diferente.',
    ],
    ...
    | Convención: 'attribute.rule' => 'mensaje'
    |
    */
    ...
    'custom' => [
        'ended_at' => [
            ...
            'required_if' => 'La fecha de fin es obligatoria cuando el trabajo no es actual.',
        ],
    ],
    ...
    |--------------------------------------------------------------------------
    |
    | Nombres legibles para los atributos en los mensajes de error.
    |
    */
    ...
    'attributes' => [
        ...
        'graduated_year' => 'año de graduación',
        ...
        'accept_messages' => 'aceptar mensajes',
        'show_email' => 'mostrar correo',

        'email_enabled' => 'notificaciones por correo',
        'push_enabled' => 'notificaciones push',
        'notify_comments' => 'notificaciones de comentarios',
        'notify_mentions' => 'notificaciones de menciones',
        ...
        'show_projects' => 'mostrar proyectos',
        'show_experience' => 'mostrar experiencia',
        'show_education' => 'mostrar educación',
