...
{{-- ── FAB: Nuevo proyecto / Publicar oferta (mobile) ── --}}
@if(Auth::user()->role !== 'guest' && !request()->routeIs('messages*'))
@if(Auth::user()->account_type === 'company')
<button class="bottom-fab" onclick="abrirJobOffer()" aria-label="Publicar oferta de empleo" title="Publicar oferta">
