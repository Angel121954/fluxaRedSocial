            ...
            <div style="padding:28px 36px 24px;border-bottom:1px solid {{ $paleta['borde'] }};">
                <div style="display:flex;align-items:center;gap:24px;">
                    ...
                    <div style="flex:1;min-width:0;">
                        ...
                        <p style="margin:0 0 12px;font-size:13px;color:{{ $paleta['textoSuave'] }};">&#64;{{ $user->username }}</p>
                        ...
                        <div>
                            ...
                            <div style="display:flex;flex-direction:column;gap:7px;">
                                ...
                                <div style="display:flex;gap:8px;align-items:center;">
                                    ...
                                    <span style="font-size:12px;color:{{ $paleta['azul'] }};">{{ $profile->website_url }}</span>
                                </div>
                                @endif
                                ...
                                <div style="display:flex;gap:8px;align-items:center;">
                                    ...
                                    <span style="font-size:12px;color:{{ $paleta['texto'] }};">{{ $profile->gender === 'male' ? 'Masculino' : ($profile->gender === 'female' ? 'Femenino' : 'No especificado') }}</span>
                                </div>
                                @endif
