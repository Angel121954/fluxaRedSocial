    ...
    <div class="login-wrapper">
        ...
        <div class="login-card">
            ...
            <div class="login-card__header">
                <h1 class="login-card__title">Crear tu cuenta</h1>
                <p class="login-card__subtitle">Únete a la red de desarrolladores latinoamericanos</p>
            </div>
            ...
            <p class="login-signup">
                ¿Ya tienes cuenta?
                <a href="{{ route('login') }}" class="login-signup__link">Inicia sesión</a>
            </p>
        </div>
