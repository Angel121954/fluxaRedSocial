    ...
    <div class="login-wrapper">
        ...
        <div class="login-card">
            ...
            <div class="login-card__header">
                ...
                <p class="login-card__subtitle">Inicia sesión para continuar en Fluxa</p>
            </div>

            {{-- Alertas de sesión --}}
            @if(request()->query('banned'))
            <div class="session-message error">
                <svg width="14" height="14" fill="currentColor" viewBox="0 0 16 16">
                    <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z" />
                    <path d="M7.002 11a1 1 0 1 1 2 0 1 1 0 0 1-2 0zM7.1 4.995a.905.905 0 1 1 1.8 0l-.35 3.507a.552.552 0 0 1-1.1 0L7.1 4.995z" />
                </svg>
                <span>Tu cuenta ha sido suspendida. No puedes iniciar sesión.</span>
            </div>
            @endif
            ...
            <form id="loginForm" method="post" action="{{ route('login') }}" novalidate>
                ...
                <a href="{{ route('auth.guest') }}" class="btn-guest">
            ...
            <p class="login-signup">
                ¿No tienes cuenta?
                <a href="{{ route('register') }}" class="login-signup__link">Regístrate aquí</a>
            </p>
        </div>
