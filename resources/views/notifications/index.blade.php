...
<div class="feed-layout">
  <div class="feed-main" style="max-width: 680px; margin: 0 auto;">
    ...
    <div class="filter-bar">
      ...
      <button class="filter-chip" data-filter="comment"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
          <path d="M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 0 1-7.6 4.7 8.38 8.38 0 0 1-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 0 1-.9-3.8 8.5 8.5 0 0 1 4.7-7.6 8.38 8.38 0 0 1 3.8-.9h.5a8.48 8.48 0 0 1 8 8v.5z" />
        </svg><span>Comentarios</span></button>
      <button class="filter-chip" data-filter="follow"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
          <path d="M16 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2" />
          <circle cx="8.5" cy="7" r="4" />
          <path d="M20 8v6m-3-3h6" />
        </svg><span>Seguidos</span></button>
      <button class="filter-chip" data-filter="like"><svg class="filter-chip__icon filter-chip__icon--like" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
