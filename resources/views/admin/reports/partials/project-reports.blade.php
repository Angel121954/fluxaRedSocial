<div class="adm-card">
    ...
    <div class="adm-empty">
        <div class="adm-empty-state">
            ...
            <p>No hay reportes de proyectos pendientes.</p>
        </div>
    </div>
    @else
        ...
        <table class="rp-table">
            ...
            <tbody>
                ...
                <tr class="rp-tr">
                    ...
                    <td class="rp-td">
                        @if($report->project)
                        <a href="{{ route('projects.show', $report->project) }}" target="_blank" class="rp-project-link">
                        ...
                        @else
                        <span class="rp-deleted">Proyecto eliminado</span>
                        @endif
                    </td>
                    ...
                    <td class="rp-td rp-td--center">
                        <div class="rp-actions">
                            <form method="POST" action="{{ route('admin.reports.project.dismiss', $report) }}" class="rp-dismiss-form">
                                @csrf
                                @method('DELETE')
