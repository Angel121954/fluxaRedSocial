<div class="adm-card">
    ...
    <div class="adm-empty">
        <div class="adm-empty-state">
            ...
            <p>No hay reportes de problemas pendientes.</p>
        </div>
    </div>
    @else
    <div class="rp-table-wrap">
        <table class="rp-table">
            <thead>
                <tr>
                    <th class="rp-th">Usuario</th>
                    <th class="rp-th">Tipo</th>
            ...
            <tbody>
                ...
                <tr class="rp-tr">
                    ...
                    <td class="rp-td">
                        <span class="rp-type-badge rp-type-badge--{{ $report->type }}">
                            @switch($report->type)
                                @case('error_tecnico') Error técnico @break
                                @case('contenido_inapropiado') Contenido inapropiado @break
                                @case('problema_cuenta') Problema de cuenta @break
                                @default Otro
                            @endswitch
                        </span>
                    </td>
                    <td class="rp-td rp-td--left">
                        <div class="rp-reason">{{ $report->message }}</div>
                    </td>
                    ...
                    <td class="rp-td rp-td--center">
                        <div class="rp-actions">
                            <form method="POST" action="{{ route('admin.reports.problem.dismiss', $report) }}" class="rp-dismiss-form">
                                @csrf
                                @method('DELETE')
